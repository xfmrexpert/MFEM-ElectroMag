...
class CapacitanceSolver : public PhysicsSolver {
...
public:
    CapacitanceSolver(mfem::Mesh &m, const json &c) : PhysicsSolver(m, c) {}
    ...
    void Run() override {
        ...
        for (auto& port : ports)
        {
            // Set voltage on port to 1.0 and all other ports to 0.0
